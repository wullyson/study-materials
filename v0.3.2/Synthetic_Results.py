...
def picture_Resize(new_w,new_h,image_throw):
    ...
    # 保存调整后的图像
    cv2.imwrite('./data/Pre-Process_2/FaceResize.png',resized_image)
...
def Synthetic():
    # 打开第一张图像
    image1 = cv2.imread("./data/Pre-Process_1/Hair_matting.png")
    image1PIL=Image.open("./data/Pre-Process_1/Hair_matting.png")
    # 打开第二张图像
    image2 = cv2.imread('./data/Pre-Process_1/Face_matting.png')
    image2PIL=Image.open("./data/Pre-Process_1/Face_matting.png")
    Wgap=0
    Hgap=0
    have=0
    # 设置新的照片大小
    ...
    if have==1:
        image2_2 = cv2.imread('./data/Pre-Process_2/incereaseW_image.png')
        image2_2PIL = Image.open('./data/Pre-Process_2/incereaseW_image.png')
    elif have==2:
        image2_2 = cv2.imread('./data/Pre-Process_2/incereaseH_image.png')
        image2_2PIL = Image.open('./data/Pre-Process_2/incereaseH_image.png')
    ...
    transparent_image1=cv2.imread('./data/Pre-Process_2/incereaseH_image.png')
    ...
    cv2.imwrite('./data/Pre-Process_2/transparent_face.png',transparent_image1)

    transparent_image2=cv2.imread('./data/Pre-Process_2/incereaseW_image.png')
    ...
    cv2.imwrite('./data/Pre-Process_2/transparent_hair.png',transparent_image2) 
