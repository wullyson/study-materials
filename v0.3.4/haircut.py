...
def haircut():
    ...
    # Arguments
    parser.add_argument('--data-folder', type=str, default='./data/Origin/Hair',help='name of the data folder (default: ./data/Hair)')
...
# 儲存頭髮去背圖片
    cv2.imwrite('./data/Pre-Process_1/Hair_matting.png', hair_image)
