...
def Scaling(image1,image2):
    ...
    dis_left_y = diff_left_y / img_height

    dis_right_x = diff_right_x / img_width
    dis_right_y = diff_right_y / img_height

    avg_x = (dis_left_x + dis_right_x) / 2.0 * 1000
    avg_y = (dis_left_y + dis_right_y) / 2.0 * 1000
    avg_total = (avg_x + avg_y) / 2.0 
    if avg_total < 0 :
        avg_total += 100
